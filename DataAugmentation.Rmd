---
title: "Data Augmentation INJURIES"
...
sim_injuries <- sim_injuries %>% 
  select(-seleccion_bin, -id, -min_fisico, -min_pista, -cabeza_tronco_bin, 
         ...
         -cabeza_tronco_n, -miembro_superior_n, -miembro_inferior_n, -cabeza_y_tronco, -miembro_superior, -miembro_inferior)
```
...
write_xlsx(sim_injuries, path = "sim_injuries.xlsx")
```